...
class TestingRepository {
  ...
  public async deleteAllFromPostgres() {
    ...
    TRUNCATE users, confirmation, "refreshTokenMeta", blogs, posts, comments, "postLike", "commentLike", "quizQuestions", "quizAnswers", "quizGame", "quizPlayerProgress", "quizQuestion"
    `)
  }
}
